...
namespace UniS.Controllers
{
    public class TransactionsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Transaction.Include(t => t.Customer);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("TransactionID,CustomerId,TransactionDate,TransactionPrice")] Transaction transaction)
        {
